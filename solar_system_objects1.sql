...
CREATE TABLE solar_system_objects(
  body TEXT
, mean_radius varchar(256)         /* km */
, mean_radius_rel varchar(256)     /* relative to earth */
, volume varchar(256)              /* 10^9 km^3 */
, volume_rel varchar(256)          /* relative to earth */
, mass varchar(256)                /* 10^21 kg */
, mass_rel varchar(256)            /* relative to earth */
, density varchar(256)             /* g/cm^3 */
, surface_gravity varchar(256)     /* m/s^2 */
, surface_gravity_rel varchar(256) /* relative to earth */
, type_of_object TEXT
, shape TEXT
);
